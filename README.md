...
Uso de componentes de Bootstrap (cards y carrusel)

Estilos personalizados con CSS

Mensajes dinámicos en tiempo real para mejorar la experiencia del usuario

Este proyecto tiene como objetivo practicar la integración de jQuery con Bootstrap y la creación de interfaces web interactivas y responsivas.
